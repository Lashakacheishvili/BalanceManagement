...
namespace BalanceManagement.Controllers
{
    ...
    public class BalanceController : BaseController
    {
        ...
        {
            return _gameBalanceManager.GetBalanceCasino();
        }
        ...
        {
            return _gameBalanceManager.TransferMoneyToPlayer(new ServiceModels.TransferModel.TransferMoneyRequestModel(transactionId,amount));
        }
        [HttpPost("deposit/{transactionId}/{amount}")]
        public BaseResponseModel TransferMoneyToCasino(string transactionId, decimal amount)
        {
          return _gameBalanceManager.TransferMoneyToCasino(new ServiceModels.TransferModel.TransferMoneyRequestModel(transactionId, amount));
        }
    }
}
